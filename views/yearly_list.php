...
<?php } ?>
    <div class="table-responsive">
      <form action=".?menu=yearly" method="POST">
        <table class="table table-striped table-bordered align-middle col2-align">
          <thead>
            <tr class="text-center row-nowrap">
              <th>
                年
                <input id="purchase-year-asc" class="btn-check" type="submit" name="order" value="1 asc" autocomplete="off"<?php echo $order === '1 asc' ? ' checked' : ''; ?>>
                <label class="btn-sm btn-secondary" for="purchase-year-asc">▲</label>
                <input id="purchase-year-desc" class="btn-check" type="submit" name="order" value="1 desc" autocomplete="off"<?php echo $order === '1 desc' ? ' checked' : ''; ?>>
              ...
              <th>
                1ヶ月あたりの平均金額
                <input id="ave-price-asc" class="btn-check" type="submit" name="order" value="4 asc" autocomplete="off"<?php echo $order === '4 asc' ? ' checked' : ''; ?>>
                <label class="btn-sm btn-secondary" for="ave-price-asc">▲</label>
                <input id="ave-price-desc" class="btn-check" type="submit" name="order" value="4 desc" autocomplete="off"<?php echo $order === '4 desc' ? ' checked' : ''; ?>>
